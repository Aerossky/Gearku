...
$dataUser = mysqli_query($conn, "SELECT * FROM user WHERE id =$id");
                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item dropdown no-arrow">
                        <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <span class="mr-2 d-none d-lg-inline text-gray-600 small">Halo <b><?php echo $row["nama"] ?></b></span>
                            <img class="img-profile rounded-circle" src="assets/imgFotoUser/<?php echo $row["foto"] ?>" />
          ...
          <div class="row no-gutters align-items-center">
            <div class="col mr-2">
              ...
              <div class="h5 mb-0 font-weight-bold text-gray-800">
                ...
                <?php
                $result = mysqli_query($conn, "SELECT id FROM barang");
        ...
        <div class="card-body">
          <div class="row no-gutters align-items-center">
            <div class="col mr-2">
              ...
              <div class="h5 mb-0 font-weight-bold text-gray-800">
                <?php
                $result = mysqli_query($conn, "SELECT status FROM barang WHERE status != 'tidak ada'");
                $total = mysqli_num_rows($result);
                echo $total;
        ...
        <footer class="sticky-footer bg-white">
            <div class="container my-auto">
                <div class="copyright text-center my-auto">
                    <span>Copyright &copy; GearKu 2022</span>
                </div>
            </div>
        </footer>
        <!-- End of Footer -->
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                Tekan Keluar, jika anda akan memberhentikan sesi anda dalam website GearKu.
            </div>
